			...
			<div class="container">
				<div class="row">
					<?php if(isset($viewData['sidebar'])): ?>
					  <div class="col-sm-3">
					  	<?php $this->loadViewInTemplate('sidebar', array('viewData'=>$viewData)); ?>
					  </div>
	    		...
	    		<div class="container">
	    			<div class="row">
						<div class="col-xs-12 col-sm-8 col-sm-offset-2 no-padding">
							<form action="https://gmail.us2.list-manage.com/subscribe/post?u=8a7722c8940c608d21fbb370b&amp;id=8feb41ab13" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
							<input type="email" value="" name="EMAIL" class="subemail required email" id="mce-EMAIL" placeholder="<?php $this->lang->get('SUBSCRIBETEXT'); ?>">
							<input type="hidden" name="b_8a7722c8940c608d21fbb370b_8feb41ab13" tabindex="-1" value="">
